...
window.title("Crăciun Fericit, miautsă!") 
...
text.write("Crăciun Fericit", font=("Apple Chancery", 30, "bold"), align="center") 
text.setposition(130, 140) 
text.color("dark green") 
text.write("Miautsă", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write(" curutsă", font=("Avenir", 30, "normal"), align="left") 
text.setx(50) 
text.hideturtle() 
